...
<body class="bg-gradient-to-r from-slate-200 to-slate-300 min-h-screen">
    <header class="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <nav class="flex space-x-8 text-slate-900 font-semibold text-sm">
            ...
            <a class="border-b-2 border-slate-400 pb-1" href="about.php">About us</a>
    ...
    <main class="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-20">
        <section class="max-w-xl flex flex-col space-y-6">
            <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight">
                <span>Quality Tools,</span><br />
                <span class="font-normal">Right at Your Fingertips</span>
            </h1>
            <div class="text-slate-900 text-sm space-y-4">
                <p class="font-bold">About us</p>
                <p>
                    HardwareHub is an e-commerce platform dedicated to offering high-quality hand tools. Our platform makes it easy to browse and purchase essential tools without the hassle of going to physical stores. HardwareHub aims to be the go-to place for all your hand tool needs, delivering a seamless online shopping experience.
                </p>
                <p class="font-bold">Our Mission</p>
                <p>
                    Our mission is to become the go-to destination for all your hardware needs. We aim to revolutionize the industry with an easy-to-navigate platform, competitive prices, and an unmatched product selection.
                </p>
            </div>
        </section>
